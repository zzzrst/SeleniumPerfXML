// <copyright file="Old_TestDataXMLParser.cs" company="PlaceholderCompany">
...
namespace SeleniumPerfXML
{
    ...
    /// </summary>
    public class Old_TestDataXMLParser
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Old_TestDataXMLParser"/> class.
        /// </summary>
        /// <param name="xmlFile"> The file path to the XML file.</param>
        public Old_TestDataXMLParser(string xmlFile)
        {
